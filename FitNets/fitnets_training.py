...
# costs imports
from costs.HintCost import HintCost
from extensions.TeacherDecayOverEpoch import TeacherDecayOverEpoch

# generate convolutional regressor
...
# to generate non convolutional regressor 
...
# main function
# define the function that have to be executed
def main():
